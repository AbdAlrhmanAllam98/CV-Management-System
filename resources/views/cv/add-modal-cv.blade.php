      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="" id="add-cv">
                ...
                <div class="form-group">
                    <label for="add-userEmail">User Email</label>
                    <input type="text" name="add-userEmail" id="add-userEmail" class="form-control">
                    <small class="form-text text-danger" id="userEmail-error-add"></small>
                  </div>
